...
export function PropertyCardVertical({ imovel, index = 0 }: Props & { index?: number }) {
  ...
  return (
    <PropertyCardAnimation 
      ...
      premium={isPremium}
      className={[
        'group bg-surface rounded-card border border-tenant-border shadow-card overflow-hidden transition-all duration-[var(--tenant-transition-default)] hover:shadow-card-hover',
